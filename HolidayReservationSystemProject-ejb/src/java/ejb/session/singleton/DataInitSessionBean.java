...
public class DataInitSessionBean {
    ...
    //guestrelo, password, Guest Relation Officer
        ...
        if (em.find(RoomRate.class, 1l) == null) {
            ...
            RoomRate deluxeRoomNormal = new RoomRate("Deluxe Room Normal", RateTypeEnum.NORMAL, 50, deluxe);
            em.persist(deluxeRoomNormal);
            em.flush();
            
            RoomRate premierRoomPublished = new RoomRate("Premier Room Published", RateTypeEnum.PUBLISHED, 200, premier);
            em.persist(premierRoomPublished);
            em.flush();

            RoomRate premierRoomNormal = new RoomRate("Premier Room Normal", RateTypeEnum.NORMAL, 100, premier);
            em.persist(premierRoomNormal);
            em.flush();
            
            RoomRate familyRoomPublished = new RoomRate("Family Room Published", RateTypeEnum.PUBLISHED, 300, family);
            em.persist(familyRoomPublished);
            em.flush();

            RoomRate familyRoomNormal = new RoomRate("Family Room Normal", RateTypeEnum.NORMAL, 150, family);
            em.persist(familyRoomNormal);
            em.flush();
            
            RoomRate juniorSuitePublished = new RoomRate("Junior Suite Published", RateTypeEnum.PUBLISHED, 400, junior);
            em.persist(juniorSuitePublished);
            em.flush();

            RoomRate juniorSuiteNormal = new RoomRate("Junior Suite Normal", RateTypeEnum.NORMAL, 200, junior);
            em.persist(juniorSuiteNormal);
            em.flush();
            
            RoomRate grandSuitePublished = new RoomRate("Grand Suite Published", RateTypeEnum.PUBLISHED, 500, grand);
            em.persist(grandSuitePublished);
            em.flush();

            RoomRate grandSuiteNormal = new RoomRate("Grand Suite Normal", RateTypeEnum.NORMAL, 250, grand);
        ...
        if (em.find(Room.class, 1l) == null) {
            ...
            Room room0305 = new Room(0135, RoomStatusEnum.AVAILABLE, null, grand);
            em.persist(room0305);
            em.flush();
